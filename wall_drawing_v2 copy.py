...
def main():
    ...
    uploaded_file = st.file_uploader("Choose an architectural drawing image", type=["png", "jpg", "jpeg"])
    ...
    if uploaded_file is not None:
        ...
        if st.button("Analyze Drawing"):
            with st.spinner("Analyzing..."):
                analysis, walls, analyzed_image, suggested_params = analyze_architectural_drawing(uploaded_file, edge_detection_params)
            ...
            _, walls, analyzed_image, _ = analyze_architectural_drawing(uploaded_file, edge_detection_params)
